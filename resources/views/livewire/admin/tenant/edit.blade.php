<div>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">{{('Edit Tenant Details')}}</h4>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="billing-first-name">{{ ('Property Name') }}</label>
                          <input type="text" readonly class="form-control custom-readonly" wire:model.defer="propertyName">
                          @error('propertyName')
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label for="billing-email-address">{{ __('lease.Property Unit') }} </label>
                              <input type="text" readonly class="form-control custom-readonly" wire:model.defer="unitName">
                            @error('propertyName')
                              <span class="text-danger font-weight-semibold">
                                {{ $message}}
                              </span>
