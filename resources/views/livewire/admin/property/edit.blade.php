<div>
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="header-title mb-3">{{ __('property.Basic Details') }}</h4>

            <div class="">
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="firstname">{{ __('property.Property Name') }} <span class="text-danger">*</span>
                            </label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="lastname">{{ __('property.Rent') }} <span class="text-danger">*</span> </label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="firstname">{{ __('property.Type') }} <span class="text-danger">*</span></label>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            <label for="userbio">{{ __('property.Description') }} <span
                                    class="text-danger">*</span></label>
                            <textarea wire:model.defer="description" class="form-control" id="userbio" rows="4"
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="header-title mb-3">{{ __('property.Property Location') }}</h4>
            ...
            <div class="">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="custom_address" wire:model.defer="street_address">
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="header-title mb-3">{{ __('property.Features & Amenities') }}</h4>
            <div class="">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-3">
                        <div class="custom-control custom-checkbox">
                            <input value="Heating" type="checkbox" class="custom-control-input" id="customCheck2"
                                   wire:model.defer="amenities">
                    ...
                    <div class="col-3">
                        <div class="custom-control custom-checkbox">
                            <input value="Internet" type="checkbox" class="custom-control-input" id="customCheck3"
                                   wire:model.defer="amenities">
                    ...
                    <div class="col-3">
                        <div class="custom-control custom-checkbox">
                            <input value="Swimming Pool" type="checkbox" class="custom-control-input" id="customCheck4"
                                   wire:model.defer="amenities">
                ...
                <div class="row mt-2">
                    <div class="col-3">
                        <div class="custom-control custom-checkbox">
                            <input value="car parking" type="checkbox" class="custom-control-input" id="customCheck5"
                                   wire:model.defer="amenities">
                    ...
                    <div class="col-3">
                        <div class="custom-control custom-checkbox">
                            <input value="Balcony" type="checkbox" class="custom-control-input" id="customCheck6"
                                   wire:model.defer="amenities">
                    ...
                    <div class="col-3">
                        <div class="custom-control custom-checkbox">
                            <input value="Garden" type="checkbox" class="custom-control-input" id="customCheck7"
                                   wire:model.defer="amenities">
                    ...
                    <div class="col-3">
                        <div class="custom-control custom-checkbox">
                            <input value="Pets allow" type="checkbox" class="custom-control-input" id="customCheck8"
                                   wire:model.defer="amenities">
                ...
                <div class="row mt-2">
                    <div class="col-3">
                        <div class="custom-control custom-checkbox">
                            <input value="Laundry room" type="checkbox" class="custom-control-input" id="customCheck9"
                                   wire:model.defer="amenities">
                    ...
                    <div class="col-3">
                        <div class="custom-control custom-checkbox">
                            <input value="Gym" type="checkbox" class="custom-control-input" id="customCheck10"
                                   wire:model.defer="amenities">
                    ...
                    <div class="col-3">
                        <div class="custom-control custom-checkbox">
                            <input value="Alarm" type="checkbox" class="custom-control-input" id="customCheck11"
                                   wire:model.defer="amenities">
                    ...
                    <div class="col-3">
                        <div class="custom-control custom-checkbox">
                            <input value="Swimming pool" type="checkbox" class="custom-control-input" id="customCheck12"
                                   wire:model.defer="amenities">
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="header-title">{{ __('property.Current Property Images') }}</h4>
            <div class="row">
                ...
                @empty
                    <div class="col-12">
                        <div class="alert alert-info" role="alert">
                            ...
                            {{ __('property.This property does not have any images.') }}
                        </div>
                    </div>
                @endforelse
            </div>
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="header-title">{{ __('property.Upload New Photos') }}</h4>
            ...
            <div class="">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group mb-3">
                        <input type="file" class="form-control " placeholder="Upload Property Images" multiple
                               wire:model.lazy="photos" aria-label="Property Images" aria-describedby="basic-addon2">
                        <div class="input-group-append">
                            <span class="input-group-text" id="basic-addon2">
                                <div class="spinner-border spinner-border-sm" wire:loading wire:target="photos"
                                     role="status">
            ...
            <div class="d-flex flex-row-reverse mt-4 mb-3 align-items-start">

                <button class="btn btn-lg btn-success waves-effect waves-light" wire:click="updateProperty"
                        wire:attr="disabled">
                    <span class="spinner-border spinner-border-sm" wire:loading wire:target="updateProperty"
                          role="status" aria-hidden="true"></span>
                    {{ __('property.Update Property') }}
                </button>
